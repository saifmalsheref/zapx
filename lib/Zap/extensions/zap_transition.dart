    ...
    transitionsBuilder: (context, animation, secondaryAnimation, child) {
      ...
      switch (transition) {
        ...
        case Transition.noTransition:
          return _buildNoTransition(animation, child);
        default:
          return _buildNoTransition(animation, child);
      }
    },
...
FadeTransition _buildNoTransition(Animation<double> animation, Widget child) {
  var fadeAnimation = Tween<double>().animate(animation);
  return FadeTransition(opacity: fadeAnimation, child: child);
}
